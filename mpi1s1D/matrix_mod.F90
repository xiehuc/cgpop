!>
!! This module contains routines multiplying a compressed sparse row matrix
!! and a vector the linear data structure in the solver.
!<
module matrix_mod
    ! !USES:
    ...
    type, public :: Matrix_t
        ...
        real(r8), dimension(9*max_linear) :: &
            Mat ! Non-zero values for standard CSR
  ...
  contains
    ...
    !  non-zero pattern is static.  This subroutine could therefore be
    !  simplified. 
    ...
    subroutine matvec(n,Mat,Y,X)
        ...
        integer (i4), intent(in) :: n ! The order of the Matrix and length of X 
                                      ! and Y
