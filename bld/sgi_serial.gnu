...
PAPIDIR = /home/tempest/dennis/papi
TRACE = -D_HTRACE
TLIBS = -L/home/tempest/dennis/validate/lib -lhtrace $(PAPIDIR)/lib/libpapi64.a
...
FBASE = $(ABI) -r10000 $(NETCDFINC) -I$(ObjDepDir)
...
ifeq ($(OPTIMIZE),yes)
  FFLAGS = $(FBASE) -O3 -OPT:reorg_common=OFF:Olimit=0
else
# FFLAGS := $(FBASE) -g 
...
LDFLAGS = $(ABI) -mips4 -r10000 -Wl,-u,MAIN__
...
%.o: %.f
	@echo SGI SERIAL Compiling with implicit rule $<
	@$(FC) $(FFLAGS) -c $<
...
$(SrcDepDir)/%$(DEPSUF): %.F
	@echo 'SGI SERIAL Making depends for preprocessing' $<
...
$(ObjDepDir)/%$(DEPSUF): %.f
	...
	@echo 'SGI SERIAL Making depends for compiling' $<
