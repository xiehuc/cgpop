...
NETCDFINC = -I/contrib/netcdf-4.1.1/include
NETCDFLIB = -L/contrib/netcdf-4.1.1/lib
...
FBASE = $(ABI) -nothreads -w90 -Vaxlib $(NETCDFINC) -I$(ObjDepDir) $(NETCDF_FLIB)
...
ifeq ($(OPTIMIZE),yes)
  FFLAGS = $(FBASE) -O3 -xT -fno-alias -fast
else
  FFLAGS = $(FBASE) -g
endif
