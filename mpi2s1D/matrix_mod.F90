...
module matrix_mod
    ...
    type, public :: Matrix_t
        ...
        real(r8), dimension(9*max_linear) :: Mat ! The non-zero values for
                                                 ! standard CSR
  ...
  contains
    ...
    subroutine ConvertStencil(Mat,A0,AN,AE,ANE)
        ...
        ! !OUTPUT PARAMETERS:
        type (Matrix_t), intent(inout) :: Mat  ! The matrix equiv of the 9-pt
                                               ! stencil
    ...
    subroutine matvec(n,Mat,Y,X)
        ...
        integer(i4) :: i, j, is, ie, nz, n2  ! integer loop temporary 
